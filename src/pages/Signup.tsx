        ...
        <div className="relative z-10">
          ...
          >
            <h1 className="text-5xl font-bold leading-tight">
              Manage Admissions <br/> with Precision.
            </h1>
            <p className="text-blue-100 text-lg leading-relaxed">
              Experience the next generation of college admission management. 
              Streamline applications, manage student intake, and make data-driven decisions.
            </p>
          </motion.div>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="mobile" placeholder="+1 (555) 000-0000" {...register('mobile')} />
                {errors.mobile && <p className="text-danger text-sm">{errors.mobile.message}</p>}
              </div>
            </div>
